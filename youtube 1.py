...
def get_format(bot, update):
    ...
    print("update=")
    print(update)
    logger.info("from {}: {}".format(bot.message.chat_id, bot.message.text)) # "history"
...
updater = Updater(token='1392923431:AAGZ88Zs5S2W1gDurRIicQVuweaFqfMbByI', use_context=True)
